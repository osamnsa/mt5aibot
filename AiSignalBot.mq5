...
// Inputs
//--------------------------------------------------------------------
input string          InpSymbols                   = "BTC,ETH,XRP,BNB,EURUSD,GBPUSD,USDCHF,USDJPY"; // Symbols to scan, comma-separated (empty = all Market Watch symbols). XAGUSD is M1-only, runs on a separate instance - don't add it here. XAUUSD/EURGBP/ZEC/XAUAUD removed - no significant edge survives proper validation.
