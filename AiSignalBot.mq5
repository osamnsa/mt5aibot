...
// Inputs
//--------------------------------------------------------------------
input string          InpSymbols                   = "BTC,ETH,EURUSD,GBPUSD,USDCHF,USDJPY,AUDUSD"; // Symbols to scan, comma-separated (empty = all Market Watch symbols). XAGUSD and XRP are M1-only, run on separate instances (InpTimeframe=PERIOD_M1) - don't add them here, XRP failed validation on M15. XAUUSD/EURGBP/ZEC/XAUAUD/BNB removed - no significant edge survives proper validation.
